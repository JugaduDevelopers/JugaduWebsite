...
const LaunchProducts = () => {
  return (
    <div className="bg-whiteSmoke px-10 md:px-20 flex flex-col py-20 justify-center items-start gap-10">
      <h2>Launch the products in these industries with our help</h2>
      <div className="grid grid-cols-1 grid-rows-6 lg:grid-cols-2 lg:grid-rows-3 md:gap-10">
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <CryptoBanks />
          <h4 className="text-black text-2xl">Crypto banks</h4>
        </div>
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <Stablecoins />
          <h4 className="text-black text-2xl">Stablecoins</h4>
        </div>
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <SmartContracts />
          <h4 className="text-black text-2xl">Custom smart contracts</h4>
        </div>
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <Logistics />
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <Contracts />
          <h4 className="text-black text-2xl">Contract execution platforms</h4>
        </div>
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          <Payment />
          <h4 className="text-black text-2xl">
