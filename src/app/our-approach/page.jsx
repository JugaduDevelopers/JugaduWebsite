...
const OurApproach = () => {
  return (
    <section className="bg-[#121519] text-[#F6F6F6]">
      <div className="container mx-auto flex flex-col items-start md:py-28 py-16 md:px-20">
      ...
      <div className="container mx-auto md:pt-28 pt-16 flex md:px-20 flex-wrap">
        <div className="md:w-3/5">
